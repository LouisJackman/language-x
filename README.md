...
Sylan is a Java-like, statically typed, multiparadigm, functional,
object-oriented, and natively compiled programming language with lightweight
concurrency.

It has powerful compile-time metaprogramming and transparently non-blocking IO
with lightweight tasks, similar to Go and Erlang.

It is designed to scale from small scripts to large codebases, remove footguns,
...
executables with no required runtimes to be installed.
