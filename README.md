...
fun demoContexts Optional[Int] {
     ...
     * Sylan calls "contexts". Haskell programmers already know the benefits of
     * this construct; non-Haskell programmers will be glad to know that this
     * feature can make tangled code such as optionality-checking chains and
     * validation code much cleaner.
     */
    with {
        Some(5)->
