...
* [Details](#details)
  ...
  - [Compile-time Metaprogramming](#compile-time-programming)
  - [Meta-linguistic Programming](#meta-linguistic-programming)
...
* Modules must whitelist which dynamicall-scoped variables it allows rebinding
